...
config :star_tickets, StarTicketsWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:star_tickets, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:star_tickets, ~w(--watch)]}
  ]
...
config :star_tickets, dev_routes: true

# Auto-run pending migrations on server start (dev only)
config :star_tickets, auto_migrate: true
